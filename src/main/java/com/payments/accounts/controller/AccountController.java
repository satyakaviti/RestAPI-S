...
import com.payments.accounts.dto.ResponseDto;
...
@Tag(
        name = "CRUD REST APIs for Accounts in SatyamBank",
        description = "CRUD REST APIs in SatyamBank to CREATE, UPDATE, FETCH AND DELETE account details"
)
@RestController
